  ...
  return (
    <div className="w-full h-full">
      <div className="flex justify-between items-center  p-4">
        <h1 className="text-sm md:text-xl lg:text-2xl  font-sans font-medium ">Blog Post</h1>

        <Link
          to={"/create"}
          type="button"
          class="text-white flex items-center text-center gap-2 lg:gap-3 focus:ring-4 font-medium rounded-lg text-xs px-2 py-1.5 lg:text-sm lg:px-4 lg:py-2.5 me-2 mb-2 bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-blue-800"
        >
            ...
            >
              <div class="flex flex-col justify-between p-4 leading-normal">
                <div className="flex gap-8">
                  <h5 class="mb-2 text-[15px] md:text-[18] lg:text-xl font-bold tracking-tight text-black">
               ...
               w-[70px] h-[18px] text-[10px] 
               sm:w-[80px] sm:h-[19px] sm:text-[11px] 
               md:w-[90px] md:h-[20px] md:text-[13px]"
                    >
                ...
                <div className="mb-3 font-normal text-gray-400 text-[9px] md:text-[10px] lg:text-xs  flex items-center gap-5">
                  <p>By Jhon doe</p>
            ...
            >
              <div class="flex flex-col justify-between p-4 leading-normal">
               ...
               md:w-[90px] md:h-[20px] md:text-[13px]"
                ...
                <div className="mb-3 font-normal text-gray-400 text-[8px] md:text-[10px] lg:text-xs flex items-center gap-5">
                  <p>By Jhon doe</p>
                  <p>Created:2024-10-26</p>
                  <p>Updated:2025-4-20</p>
                </div>
        ...
        <div className="flex flex-col md:flex-row  gap-5 ">
          <div>
            ...
            >
              <div class="flex flex-col justify-between p-4 leading-normal">
                <div className="flex gap-8">
                  <h5 class="mb-2 text-[15px] lg:text-xl font-bold tracking-tight text-black">
                    Noteworthy technology acquisitions 2021
                  </h5>
               ...
               w-[70px] h-[18px] text-[10px] 
               sm:w-[80px] sm:h-[19px] sm:text-[11px] 
               lg:w-[90px] lg:h-[20px] lg:text-[13px]"
                    >
                      <p className="text-white">PUBLISHED</p>
                    </div>
                ...
                <div className="mb-3 font-normal text-gray-400 text-[8px] lg:text-xs  flex items-center gap-5">
                  <p>By Jhon doe</p>
                  <p>Created:2024-10-26</p>
                  <p>Updated:2025-4-20</p>
                </div>
